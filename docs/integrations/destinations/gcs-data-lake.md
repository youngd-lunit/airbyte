...
|:--------|:-----------|:-------------------------------------------------------------|:--------------------------------------------------------------------------------------|
| 1.0.8   | 2026-06-26 |                                                              | Fix dedup failure ("Cannot add field id as an identifier field: not a required field") on existing/partially-created tables by promoting PK columns to required before setting identifier fields |
