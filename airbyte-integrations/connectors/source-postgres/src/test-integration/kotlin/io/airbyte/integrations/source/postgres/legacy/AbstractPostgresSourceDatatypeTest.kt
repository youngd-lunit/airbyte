...
abstract class AbstractPostgresSourceDatatypeTest : AbstractSourceDatabaseTypeTest() {
    ...
    override fun initTests() {
        ...
        for (type in mutableSetOf<String?>("bit varying", "varbit")) {
            addDataTypeTestData(
                TestDataHolder.builder()
        ...
        for (type in mutableSetOf<String?>("boolean", "bool")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
        ...
        for (type in mutableSetOf<String?>("character", "char")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.STRING)
        ...
        for (type in mutableSetOf<String?>("varchar", "text")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.STRING)
        ...
        for (type in mutableSetOf<String?>("date", "date not null default now()")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType("date")
        ...
        for (type in mutableSetOf<String?>("integer", "int", "int4")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.INTEGER)
        ...
        for (type in mutableSetOf<String?>("double precision", "float", "float8")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.NUMBER)
        ...
        for (type in mutableSetOf<String?>("real", "float4")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.NUMBER)
        ...
        for (type in mutableSetOf<String?>("smallint", "int2")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.INTEGER)
        ...
        for (type in mutableSetOf<String?>("smallserial", "serial2")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.INTEGER)
        ...
        for (type in mutableSetOf<String?>("serial", "serial4")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType(type)
                    .airbyteType(JsonSchemaType.INTEGER)
        ...
        // time without time zone
        for (fullSourceType in mutableSetOf<String?>("time", "time without time zone")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType("time")
                    .fullSourceDataType(fullSourceType)
        ...
        // timestamp without time zone
        for (fullSourceType in mutableSetOf<String?>("timestamp", "timestamp without time zone")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    .sourceType("timestamp")
                    .fullSourceDataType(fullSourceType)
        ...
        for (fullSourceType in mutableSetOf<String?>("timestamptz", "timestamp with time zone")) {
            addDataTypeTestData(
                TestDataHolder.builder()
        ...
        addDataTypeTestData(
            TestDataHolder.builder()
                ...
                .addExpectedValues(
                    ...
                    "999.99",
                    "1001.01",
                    (-1000.0).toString(), /* "-92233720368547758.08", "92233720368547758.07" */
                )
                .build(),
        )
    }
        ...
        for (fullSourceType in mutableSetOf<String?>("timetz", "time with time zone")) {
            addDataTypeTestData(
                TestDataHolder.builder()
                    ...
                    .addExpectedValues(
                        null,
                        "13:00:01.123456-07:00",
                        "13:00:01+08:00",
                        "13:00:03-08:00",
                        "13:00:04Z",
                        "13:00:05.012345-08:00",
                        "13:00:06+08:00",
                    )
                    .build(),
            )
